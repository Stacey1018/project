        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form >
                    ...
                    <label>型号:</label>  <input name="proname" type="text" ></label> <br>
                    <label>价格:</label>  <input name="price" type="text" ></label> <br>
                    <label>剩余量:</label>  <input name="ramin" type="text" ></label> <br>
                    <label>种类:</label>  <input name="type" type="text" ></label> <br>
                    <label>颜色:</label>  <input name="color" type="text" ></label> <br>
                    <label>内存:</label>  <input name="ram" type="text" ></label> <br>
