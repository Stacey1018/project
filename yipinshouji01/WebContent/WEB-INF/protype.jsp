        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form >
                    ...
                    <label>种类:</label>  <input name="protype" type="text" ></label> <br>
                    <label>叶子节点  <input name="jiedian" type="radio"  id="1" value=""/><br>
                    <label>父亲节点<input name="jiedian" type="radio" id="2"  value=""/><br>
                    <span id="output"></span>
                </form>
<script> 
...
<script type="text/javascript">
    ...
    function addfun(){
            ...
            var leafnode =$("input[id='1']").is(':checked');
            var fathernode =$("input[id='2']").is(':checked');
    ...
    function funupdate(){
        ...
        var leafnode =$("input[id='3']").is(':checked');
        var fathernode =$("input[id='4']").is(':checked');
